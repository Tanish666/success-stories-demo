              ...
              {comments.map((comment) => (
                ...
                >
                  <div className="flex items-center">
                    ...
                    >
                        <img src={comment.avatarColor} className="absolute z-50" alt="" />
                      <svg
          ...
          >
            <div className="relative flex items-center rounded-3xl bg-[#3d3d40] p-1">
              ...
              <button
                ...
                className="ml-2 rounded-3xl bg-[#2e5bf7] text-white  px-4 py-1 font-semibold transition hover:bg-[#2e5bf7]"
              >
                Send
              </button>
            </div>
